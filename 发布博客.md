...
```
给templates/pub_blog.html导入jquery
```
<script src="{% static 'jquery/jquery-3.7.1.min.js' %}"></script>
```
为发布按钮添加一个id
```
<button class="btn btn-primary" id="submit-bt">发布</button>
```
在templates/pub_blog.html的表单中添加
```
{% csrf_token %}
```
在static/js/pub_blog.js添加ajax请求
```
...
```
修改templates/blog_detail.html详情页面模板
```
<h1>{{ blog.title }}</h1>
    <hr>
    <div class="mt-2">
